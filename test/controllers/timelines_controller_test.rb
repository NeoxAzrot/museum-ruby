...
class TimelinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timeline" do
    assert_difference('Timeline.count') do
      post timelines_url, params: { timeline: { description: @timeline.description, icon: @timeline.icon, title: @timeline.title } }
    end
  ...
  test "should update timeline" do
    patch timeline_url(@timeline), params: { timeline: { description: @timeline.description, icon: @timeline.icon, title: @timeline.title } }
