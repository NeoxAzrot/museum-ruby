...
class ArtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create art" do
    assert_difference('Art.count') do
      post arts_url, params: { art: { author: @art.author, date: @art.date, description: @art.description, image: @art.image, title: @art.title } }
    end
  ...
  test "should update art" do
    patch art_url(@art), params: { art: { author: @art.author, date: @art.date, description: @art.description, image: @art.image, title: @art.title } }
